...
<title>Document Groups Dashboard | <? echo $site_settings['name']; ?></title>
	...
	<div id='page'>
        ...
        <div class='content'>
        	<div class='single_column'>
        		<h1>Document Group Dashboard</h1>
            </div>
                ...
                <?
					...
					while($group = mysql_fetch_assoc($groups)){
						...
						?><div class='table_row <? echo $odd; ?>'>
                            <span class='table_column centered' style='width:15%;'><a href='<? echo constant("ARCH_INSTALL_PATH"); ?><? echo constant("ARCH_HANDLER_MANAGE"); ?>/develop/document_groups/edit_group/?g=<? echo $group['document_group_ID']; ?>'>Edit</a></span>
                            <span class='table_column' style='width:85%;'><? echo $group['document_group_name']; ?> || <a href='<? echo constant("ARCH_INSTALL_PATH"); ?><? echo constant("ARCH_HANDLER_MANAGE"); ?>/develop/document_groups/delete_group/?g=<? echo $group['document_group_ID']; ?>' class='confirm'><em>(delete)</em></a></span>
                        </div><?
						$counter++;
					}
