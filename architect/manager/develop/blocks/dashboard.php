...
<title>Block Dashboard | <? echo $site_settings['name']; ?></title>
                ...
                <?
					...
					while($block = mysql_fetch_assoc($blocks)){
						...
						?><div class='table_row <? echo $odd; ?>'>
                            <span class='table_column centered' style='width:15%;'><a href='<? echo constant("ARCH_INSTALL_PATH"); ?><? echo constant("ARCH_HANDLER_MANAGE"); ?>/develop/blocks/edit_block/?b=<? echo $block['block_ID']; ?>'>Edit</a></span>
                            <span class='table_column' style='width:85%;'><? echo $block['block_name']; ?> || <a href='<? echo constant("ARCH_INSTALL_PATH"); ?><? echo constant("ARCH_HANDLER_MANAGE"); ?>/develop/blocks/delete_block/?b=<? echo $block['block_ID']; ?>' class='confirm'><em>(delete)</em></a></span>
                        </div><?
						$counter++;
					}
